...
import pl.createcompetition.userservice.microserviceschanges.JwtTokenDto;
...
//    private static final String UPDATE_EMAIL = "UPDATE_EMAIL";
    ...
    public ValidJwtToken exchangePasswordForToken(
        ...
        try {
            authorizationUri = new URIBuilder(authServerUrl  + "/realms/appdevelopercompetition/protocol/openid-connect/token").build();
